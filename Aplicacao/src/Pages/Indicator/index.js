    ...
    function drawInfoTable() {
        return (
            <ListGroup>
                ...
                {propsDevice.includes('lat') ? <ListGroup.Item>Último valor de Latitude: {verificaProp('lat', dadosDevice)} </ListGroup.Item> : ""}
                {propsDevice.includes('long') ? <ListGroup.Item>Último valor de Longitude: {verificaProp('long', dadosDevice)}</ListGroup.Item> : ""}
